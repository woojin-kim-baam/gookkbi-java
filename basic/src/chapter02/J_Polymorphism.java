...
class Teacher extends People{
	...
	Teacher(String name, int age, String subject){ // 위에 기본 생성자가 아니기에 상속받는 teacher는 이를 super를 통해 생성자 호출 해야함)
		super(name, age); 
...
public class J_Polymorphism {
	...
	public static void main(String[] args) {
		...
		// System.out.println(people2.subject); subject는 안돼! 
		// 그렇다고 힙영역에 있는 subject가 사라지는게 아니라 이를 못보게되는 시야가 된거임(참조기때문!).
		...
		// 업캐스팅이 되지 않은 참조변수에 대해서는 다운캐스팅 작업 시 예외 발생!
		// Student student2 = (Student)people1;
		
		// Object를 활용한 업캐스팅 다운캐스팅
		// 모든 객체는 object로 업캐스팅 가능
